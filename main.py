...
def GoalPrinter():
    goalpen.clear()  # Bersihkan teks sebelumnya, jika ada
    goalpen.write('GOAL!', move=False, align="center", font=("Deja Vu Sans Mono", 135, "normal"))
    win.update()  # Perbarui layar untuk memastikan teks ditampilkan

def GoalCleaner():
    goalpen.clear()  # Hapus teks
    win.update()  # Perbarui layar setelah menghapus teks
...
#untuk goal team blue
        ...
        for defender in rdefenders:
            if ball.xcor() > 40/100*w/2 and team == 0:
                ...
                defender.seth(defender.towards(defender.xcor() , random.randint(-450 , 450)))
                defender.fd(2)
#perilaku team merah ketika memegang bola
